...
mdb.models['Model-1'].materials['Aluminium'].Density(table=((6500.0, ), ))
#Create Elastomer
...
mdb.models['Model-1'].materials['TT_matl'].Density(table=((6500.0, ), ))
...
mdb.models['Model-1'].materials['TT_matl1'].Density(table=((6500.0, ), ))
...
mdb.models['Model-1'].ExpressionField(name='AnalyticalField-1', 
    localCsys=datum, description='', expression='R/0.02*Z/0.095')
a = mdb.models['Model-1'].rootAssembly
