...
V=0.500; # Vertical plate length
G=0.025/4;   # Gap length
HNG=-0.015; # Hinge height
...
IRTT=0.007
TTL=0.1275
#theta=asin((sin(phiR2)-sin(phiL2))/3)
#Hnet=(Total)/(3*cos(theta)+cos(phiL2)+cos(phiR2));
#H=Hnet-G;
...
a.LinearInstancePattern(instanceList=('Middle_Plate','Right_Plate','Right_Plate_2','Left_Plate','Left_Plate_2', ), direction1=(1.0, 0.0, 
	0.0), direction2=(0.0, 1.0, 0.0), number1=1, number2=2, spacing1=(LD+V), 
	spacing2=(LD+V))
a = mdb.models['Model-1'].rootAssembly
a.LinearInstancePattern(instanceList=('Middle_Plate','Right_Plate','Right_Plate_2','Left_Plate','Left_Plate_2', ), direction1=(1.0, 0.0, 
	0.0), direction2=(0.0, -1.0, 0.0), number1=1, number2=2, spacing1=(LD+V), 
...
a = mdb.models['Model-1'].rootAssembly
RP=a.ReferencePoint(point=(DVct[0],DVct[1]+(V-2*D-TTL), DVct[2]))
RP21=RP.id
a = mdb.models['Model-1'].rootAssembly
RP=a.ReferencePoint(point=(DVct[0],DVct[1], DVct[2]))
RP27=RP.id
...
if Elastomerr==1:
	...
	for xloc in range(start,end):
		...
		if xloc==(start+end)/2:
			...
			# for i in range(len(Dataxloc)-1):
				# Presloc=np.vstack((Presloc,[Dataxloc[i,1],-(Dataxloc[i,2]),0.0315*xloc]))
	...
	W=p.Wire(sketchPlane=d2[DPP], sketchUpEdge=d2[DPE], sketchPlaneSide=SIDE1, 
		sketchOrientation=RIGHT, sketch=s)
	s.unsetPrimaryObject()
	p.Set(edges=[e.findAt(((Pathloc[1,1], Pathloc[1,2]+0.0315*(loca-0.5)*tan(6.841917290255273E-02), Pathloc[1,0]-11.85+0.0315*(loca-0.5)), ),  ) for loca in range(1,end-start)], name='PathWire')
	DP=p.DatumPlaneByPrincipalPlane(principalPlane=YZPLANE, offset=0.15)
	DPP=DP.id
	p = mdb.models['Model-1'].parts['Elastomer']
	p.featuresById[W.id]
	...
	W=p.Wire(sketchPlane=d2[DPP], sketchUpEdge=d2[DPE], sketchPlaneSide=SIDE1, 
		sketchOrientation=RIGHT, sketch=s)
	s.unsetPrimaryObject()
	p.Set(edges=[e.findAt(((Pathloc[1,4], Pathloc[1,5]+0.0315*(loca-0.5)*tan(6.841917290255273E-02), Pathloc[1,3]-11.85+0.0315*(loca-0.5)), ),  ) for loca in range(1,end-start)], name='PathWire2')
	...
	for loc in range(3):
		Vct[loc]= mdb.models['Model-1'].rootAssembly.instances['Middle_PlateT'].datums[DP7].pointOn[loc]-Axis_start[loc]
	a = mdb.models['Model-1'].rootAssembly
	a.translate(instanceList=('Elastomer', ), vector=(Vct[0],Vct[1]+0.5*((0.0315*(end-1)-0.0315*start)/cos(6.841917290255273E-02)-3*V-2*LD),Vct[2]))
	#Defining the face partitions
	print 'Partitioning part'
	p = mdb.models['Model-1'].parts['Elastomer']
...
for rowname in ['','T','L']:
	...
	a.WirePolyLine(points=((r1[eval('RP%s1'%rowname)], v1.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate%s'%rowname].datums[DP3].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s2'%rowname)], v2.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Middle_Plate%s'%rowname].datums[DP1].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s3'%rowname)], v1.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate%s'%rowname].datums[DP4].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s4'%rowname)], v2.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate%s'%rowname].datums[DP2].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s6'%rowname)], v3.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate%s'%rowname].datums[DP1].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s8'%rowname)], v3.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Middle_Plate%s'%rowname].datums[DP4].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s7'%rowname)], v1.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Middle_Plate%s'%rowname].datums[DP3].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s5'%rowname)], v1.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate%s'%rowname].datums[DP4].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((v3.findAt(coordinates=(DVct[0],DVct[1], DVct[2])), r1[eval('RP%s16'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)			
	DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate%s'%rowname].datums[DP3].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((v3.findAt(coordinates=(DVct[0],DVct[1], DVct[2])), r1[eval('RP%s14'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)				
	DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate%s'%rowname].datums[DP2].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((v2.findAt(coordinates=(DVct[0],DVct[1], DVct[2])), r1[eval('RP%s10'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)				
	DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate%s'%rowname].datums[DP1].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((v2.findAt(coordinates=(DVct[0],DVct[1], DVct[2])), r1[eval('RP%s12'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)				
	DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate_2%s'%rowname].datums[DP3].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s9'%rowname)], v4.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)	
	DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate_2%s'%rowname].datums[DP4].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s11'%rowname)], v4.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)	
	DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate_2%s'%rowname].datums[DP2].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s13'%rowname)], v5.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)		
	DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate_2%s'%rowname].datums[DP1].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s15'%rowname)], v5.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)		
	# DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate_2%s'%rowname].datums[DP1].pointOn
	# a = mdb.models['Model-1'].rootAssembly
	# r11 = a.referencePoints
	# a.WirePolyLine(points=((r1[eval('RP%s21'%rowname)], v4.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)	
	DVct=mdb.models['Model-1'].rootAssembly.instances['Right_Plate_2%s'%rowname].datums[DP2].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s20'%rowname)], v4.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	# DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate_2%s'%rowname].datums[DP3].pointOn
	# a = mdb.models['Model-1'].rootAssembly
	# r11 = a.referencePoints
	# a.WirePolyLine(points=((r1[eval('RP%s22'%rowname)], v5.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
	DVct=mdb.models['Model-1'].rootAssembly.instances['Left_Plate_2%s'%rowname].datums[DP4].pointOn
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r1[eval('RP%s23'%rowname)], v5.findAt(coordinates=(DVct[0],DVct[1], DVct[2]))), ), mergeType=IMPRINT, meshable=OFF)
...
for rowname in ['','T','L']:
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s1'%rowname)], r11[eval('RP%s2'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s3'%rowname)], r11[eval('RP%s4'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s5'%rowname)], r11[eval('RP%s6'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s7'%rowname)], r11[eval('RP%s8'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s9'%rowname)], r11[eval('RP%s10'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s11'%rowname)], r11[eval('RP%s12'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s13'%rowname)], r11[eval('RP%s14'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s15'%rowname)], r11[eval('RP%s16'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s21'%rowname)], r11[eval('RP%s27'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s20'%rowname)], r11[eval('RP%s26'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s22'%rowname)], r11[eval('RP%s28'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
	...
	a = mdb.models['Model-1'].rootAssembly
	r11 = a.referencePoints
	a.WirePolyLine(points=((r11[eval('RP%s23'%rowname)], r11[eval('RP%s29'%rowname)]), ), mergeType=IMPRINT, meshable=OFF)
	a = mdb.models['Model-1'].rootAssembly
	e1 = a.edges
	edges1 = e1.findAt(((DVct[0],DVct[1], DVct[2]), ))
...
for rowname in ['','T','L']:
	...
	a = mdb.models['Model-1'].rootAssembly
	r1 = a.referencePoints
	refPoints1=(r1[eval('RP%s17'%rowname)], )
	...
	a = mdb.models['Model-1'].rootAssembly
	r1 = a.referencePoints
	refPoints1=(r1[eval('RP%s18'%rowname)], )
	region1=regionToolset.Region(referencePoints=refPoints1)
	...
	a = mdb.models['Model-1'].rootAssembly
	r1 = a.referencePoints
	refPoints1=(r1[eval('RP%s19'%rowname)], )
	region1=regionToolset.Region(referencePoints=refPoints1)
	...
	a = mdb.models['Model-1'].rootAssembly
	r1 = a.referencePoints
	refPoints1=(r1[eval('RP%s24'%rowname)], )
	region1=regionToolset.Region(referencePoints=refPoints1)
	...
	a = mdb.models['Model-1'].rootAssembly
	r1 = a.referencePoints
	refPoints1=(r1[eval('RP%s25'%rowname)], )
	region1=regionToolset.Region(referencePoints=refPoints1)
...
if Elastomerr==1:
	...
	edges1 = e1.findAt(((DVct[0]-Pad,DVct[1],DVct2[2]-0.5*elast_thk), ))
	e2 = a.instances['Elastomer'].faces
	edges2 = e1.findAt(((-DVct[0]+Pad,DVct[1],DVct2[2]-0.5*elast_thk), ))
...
DataFile.write('%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f\n' % (IRTT,ORTT,T1,T2,T3,G,HNG,phiL2,phiR2,initial[2],initial[12],initial[3],initial[13],initial[0],initial[10],initial[1],initial[11],initial[8],initial[18],initial[9],initial[19],initial[6],initial[16],initial[7],initial[17],initial[4],initial[14],initial[5],initial[15],tipDisp[20],TT1_THE,TT2_THE,TT3_THE,TT1_EE,TT2_EE,TT3_EE,ELAST_EE,TT1_S,TT2_S,TT3_S,ELAST_S, ))
DataFile.close()
DataFile = open('PostDataFinal.txt','a')
DataFile.write('%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,%10f,' % (IRTT,ORTT,T1,T2,T3,G,HNG,phiL2,phiR2,final[2],final[12],final[3],final[13],final[0],final[10],final[1],final[11],final[8],final[18],final[9],final[19],final[6],final[16],final[7],final[17],final[4],final[14],final[5],final[15],tipDisp[20],TT1_THE,TT2_THE,TT3_THE,TT1_EE,TT2_EE,TT3_EE,ELAST_EE,TT1_S,TT2_S,TT3_S,ELAST_S, ))
DataFile.close()
print 'DONE!!'
